...
modelFileName = 'Rajagopal2015_opensense.osim';          % The path to an input model
orientationsFileName = 'TestGData_orientations.sto';   % The path to orientation data for calibration 
sensor_to_opensim_rotations = Vec3(pi/2, pi, 0);% The rotation of IMU data to the OpenSim world frame 
baseIMUName = '';                     % The base IMU is the IMU on the base body of the model that dictates the heading (forward) direction of the model.
baseIMUHeading = '';                           % The Coordinate Axis of the base IMU that points in the heading direction. 
